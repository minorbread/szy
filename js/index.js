$(function() {
	...
	$("#myTab li a").hover(function(e) {
		$("#myTab li a span").removeClass(" glyphicon glyphicon-chevron-right");
		$(this).click().children('span').addClass(" glyphicon glyphicon-chevron-right");
	}, function() {
